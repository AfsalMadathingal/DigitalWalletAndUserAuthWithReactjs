      ...
      <div className="w-full max-w-md bg-white shadow-md rounded-2xl p-6">
        ...
        <div className="mb-4">
          ...
          <div className="flex items-center border rounded-lg px-3 py-2 mt-1 bg-gray-50">
            ...
            <input type="text" className="w-full border-none outline-none bg-transparent ml-3" placeholder="Enter your Email" />
          </div>
        </div>
        ...
        <div className="mb-4">
          ...
          <div className="flex items-center border rounded-lg px-3 py-2 mt-1 bg-gray-50 relative">
            ...
            <input type={showPassword ? "text" : "password"} className="w-full border-none outline-none bg-transparent ml-3" placeholder="Enter your Password" />
        ...
        <button className="w-full py-2 bg-blue-500 text-white rounded-lg transition duration-200 btn-grad">Sign In</button>

        <p className="text-sm text-gray-700 mt-4">Don't have an account? <a href="#" className="text-blue-500 ">Sign Up</a></p>
